...
void calc_sector_transition_zones(const rotation_accumulator_t* acc, float* zone_left_start, float* zone_left_end, float* zone_right_start, float* zone_right_end) {
	...
	case 0:
		*zone_left_start  = 0.5f;
		*zone_left_end    = 0.75f;
		*zone_right_start = 0.25f;
		*zone_right_end   = 0.5f;
		break;
	case 1:
		*zone_left_start  = 0.75f;
		*zone_left_end    = 1.0f;
		*zone_right_start = 0.5f;
		*zone_right_end   = 0.75f;
		break;
	case 2:
		*zone_left_start  = 0.0f;
		*zone_left_end    = 0.25f;
		*zone_right_start = 0.75f;
		*zone_right_end   = 1.0f;
		break;
	case 3:
		*zone_left_start  = 0.25f;
		*zone_left_end    = 0.5f;
		*zone_right_start = 0.0f;
		*zone_right_end   = 0.25f;
		break;
	default:
